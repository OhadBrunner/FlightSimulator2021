...
public class Settings {
    private HashMap<String, Features> flightFeatureHashMap;
    ...
    private final List<String> featureNames = Arrays.asList("aileron", "throttle", "elevator", "rudder", "heading", "yaw", "roll", "pitch", "airspeed", "altitude");//Features

    public Settings(String file) { //file settings
    ...
    public void loadSettings() throws Exception {
        ...
        //opening new JSON file for it to be prepared
        ...
        for (Object featuresSetting : featuresSettings) {
            ...
            Features ff = new Features((String) feature.get("FeatureName"), ((Long) feature.get("min")).floatValue(),
    ...
    public HashMap<String, Features> getFlightFeatureHashMap() {
