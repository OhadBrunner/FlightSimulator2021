...
public class HybridAlgo implements TimeSeriesAnomalyDetector {
	...
	public HashMap<String, CorrelatedFeatureCircle> hashMapC;//using hash map for circle
	public HashMap<String, CorrelatedFeaturesLine> hashMapL;//using hash map for line
	...
	public void learnNormal(TimeSeries ts) {
		...
		float[] arrayX, arrayY;
		int x, y, i, j;
		int size = ts.data.get(0).length;//size of rows
		Point[] temp;
		Line lin_reg;
		for (i = 0; i < size; i++) 
		{
