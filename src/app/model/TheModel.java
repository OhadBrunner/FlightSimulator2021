...
public class TheModel{
    private Settings flightSettings;
    ...
    //checking if the TimeSeries/ flightSettings/ timeSeries exist in the model and see if it's possible to work
    ...
    // getting the information of ValueTilTime from the CSV
    ...
    //adding the right AnomalyValue of the current value that we are chose in the large Graph
    ...
    //adding the right AnomalyValue of the current value that we are chose in the small Graph
    ...
    // Adding Lines in the Graph by getting it from the CSV
    ...
    //how the painter knows how to paint the information
    public void paintHybrid(String atribute, XYChart.Series s) {
        Platform.runLater(()->{
                ...
                //painting the dot itself inside the graph
                ...
                //the points that the graph needs from the CSV file
    ...
    public Settings getFlightSettings() {
        return flightSettings;
    }

    
    public void setFlightSettings(Settings flightSettings) {
    ...
    // loading the Indexes from the  flightSettings
