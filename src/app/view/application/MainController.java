...
public class MainController {
    ...
    // initializing the change inside the view itself by binding the properties
    ...
    private void bindMenuBarProperties() {
        menuBar.getAlgorithmFile().bindBidirectional(vm.getAlgoFile());
        menuBar.getCsvFile().bindBidirectional(vm.getCsvFile());
        menuBar.getSettingFile().bindBidirectional(vm.getSettingFile());
    }
